...
function _encodeMessage(message, bb) {
  ...
  if ($file !== undefined) {
    writeVarint32(bb, 58);
    writeVarint32(bb, $file.length), writeBytes(bb, $file);
  }
...
function _decodeMessage(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string fromUsername = 2;
      case 2: {
        message.fromUsername = readString(bb, readVarint32(bb));
        break;
      }
      ...
      // optional bytes file = 7;
      case 7: {
        message.file = readBytes(bb, readVarint32(bb));
        break;
      }
      ...
      // optional int64 filesize = 11;
      case 11: {
        message.filesize = readVarint64(bb, /* unsigned */ false);
        break;
      }
...
export function decodeUser(binary) {
...
export function encodeGroup(message) {
  let bb = popByteBuffer();
  _encodeGroup(message, bb);
  return toUint8Array(bb);
}

function _encodeGroup(message, bb) {
  // optional int32 id = 1;
  let $id = message.id;
  if ($id !== undefined) {
    writeVarint32(bb, 8);
  ...
  if ($userId !== undefined) {
    writeVarint32(bb, 40);
    writeVarint64(bb, intToLong($userId));
  }
}

export function decodeGroup(binary) {
  return _decodeGroup(wrapByteBuffer(binary));
}

function _decodeGroup(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional int32 userId = 5;
      case 5: {
        message.userId = readVarint32(bb);
        break;
      }
